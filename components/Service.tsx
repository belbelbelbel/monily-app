...
const Service = () => {
  return (
    <div className='w-full md:h-[105rem] h-[25rem] flex flex-col   text-white bg-bg-img-5 bg-no-repeat bg-right-top  bg-black'>
      ...
      <div className='h-[50%] text-center gap-4   flex-col justify-center items-center flex w-full '>
        <div className={`${sans.className} w-[50%] text-[3.1rem] text-transparent bg-gradient-to-r from-[#006270] via-gray-300 to-blue-500 bg-clip-text animate-shine `}>Buy and sell with the lowest fees in the industry</div>
