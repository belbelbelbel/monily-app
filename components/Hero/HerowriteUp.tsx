  ...
  return (
    <div className='flex items-center gap-4  z-40 relative flex-col'>
      ...
      <div className='flex flex-col gap-4 items-center'>
        <div className='text-opacity-60 text-center w-[22rem] lt:text-[1.3rem] xl:text-[1rem] lt:w-[30rem]   md:w-[32rem] md:w-[37rem] text-white'>Buy, sell, and grow your crypto with Monily, the platform dedicated to every trader at every level.</div>
        <div>
