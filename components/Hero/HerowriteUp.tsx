  ...
  return (
    <div data-aos="fade-up" data-aos-anchor-placement="center-bottom" className={` ${sans.className} flex items-center gap-4  z-40 relative flex-col`}>
      ...
      <div className='flex flex-col gap-4 items-center'>
        ...
        <div>
        <Button className={`font-bold xl:text-[1.3rem] w-full xl:w-[140%] 3xl:text-[1.7rem] lg:text-[1.5rem] rounded-[8px] text-[1.03rem] lt:text-[1.75rem] md:text-[1.85rem] bg-gradient-to-r from-[#006270] via-black to-[#006270] p-6 lt:p-10  lg:p-8 xl:py-6 xl:px-6 3xl:p-8  ${sans.className}`}>Get Started</Button>
        </div>
      </div>
    </div>
  )
