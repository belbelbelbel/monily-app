...
const Details = () => {
  ...
  return (
    <div className={`${sans.className} w-full bg-black bg-bg-img-3  bg-no-repeat bg-cover bg-left   flex-col flex gap-4  items-center justify-center text-white h-[35rem] md:h-[40rem] 3xl:h-[40rem] xl:h-[37rem] lg:h-[47rem]`} >
      ...
      <div>
        <Button className={`font-bold xl:text-[1.3rem] xl:w-[130%] 3xl:text-[1.7rem] lg:text-[1.5rem] rounded-[8px] text-[1.03rem] lt:text-[1.75rem] md:text-[1.85rem] bg-gradient-to-r from-[#006270] via-black to-[#006270] p-6 lt:p-10  lg:p-8 xl:py-6 xl:px-6 3xl:p-8  ${sans.className}`}>Get Started</Button>
      </div>
    </div>
  )
}
